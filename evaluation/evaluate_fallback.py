...
if __name__ == "__main__":
    ...
    for sample in eval_set:
        ...
        predicted_fallback = system_fallback(
            result
        )
        ...
        if (
            expected_fallback
            and predicted_fallback
        ):
            true_positive += 1


        elif (
            not expected_fallback
            and not predicted_fallback
        ):
            true_negative += 1
